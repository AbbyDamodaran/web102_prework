...
function addGamesToPage(games) {
    ...
    for (const game of games) {
        ...
        gameCard.innerHTML = `
            ...
            <p style="color: lightblue;"><b>Amount pledged so far: ${game.pledged}</b></p>
        `;
...
contributionsCard.innerHTML = `
    <p id="num-contributions">${totalContributions.toLocaleString()}</p>
`;
...
raisedCard.innerHTML = `
    <p id="total-raised">$${totalRaised.toLocaleString()}</p>
`;
...
const descriptionText = `
    ...
    Currently, ${numUnfundedGames === 1 ? 'there is 1 game' : `there are ${numUnfundedGames} games`} 
...
// Secret key component 2: Get the first word of the second most funded game
const firstWordSecondTopGame = secondTopGame.name.split(' ')[0];

// Step 2: Create a new element to hold the name of the top pledge game, then append it to the correct element
